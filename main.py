...
def get_citation_args():
    ...
    parser.add_argument('--dataset', type=str, default='BanFake',
                        choices = ['BanFake','mr'],
...
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, train_size, test_size = load_corpus('BanFake')
